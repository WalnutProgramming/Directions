...
const arcade = new Hallway([
  new Fork(LEFT+RIGHT, 'arcade to 2600s', 'the 2600s'),
  new Fork(2*FRONT, 'arcade to 2700s', 'the 2700s'),
  //new Turn(RIGHT),
  new Fork(RIGHT>>RIGHT>>(LEFT&FRONT), 'arcade to musicEntrance', 'the music lyceum'),
  //new Turn(RIGHT),
  new Room('Senior High Gym', 0xFDCB24DEC9, null, "the"),
